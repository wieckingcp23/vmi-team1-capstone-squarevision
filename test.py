...
def nms():
    try:
        ...
        txtNMS.config(text = "ERROR: " + txtNMS.get() + " is an invalid input", background = "red", font=('Arial bold', 10))
...
""" 
spacer = tk.Label(buttonFrame, text="")
spacer.grid(row=4, column=0, sticky =tk.W+tk.E)
spacer1 = tk.Label(buttonFrame, text="")
spacer1.grid(row=5, column=1, sticky =tk.W+tk.E)
spacer2 = tk.Label(buttonFrame, text="")
spacer2.grid(row=6, column=2, sticky =tk.W+tk.E) """
